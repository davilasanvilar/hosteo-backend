...
public interface ApartmentRepository extends JpaRepository<Apartment, UUID> {
        ...
        List<Apartment> advancedSearch(String username, String name, ApartmentStateEnum state, Boolean visible,
                        Pageable pageable);
        ...
        int advancedCount(String username, String name, ApartmentStateEnum state, Boolean visible);
