...
public class TemplateController {
    ...
    public ResponseEntity<ApiResponse<Template>> createTemplate(@Valid @RequestBody TemplateCreateForm form,
            BindingResult bindingResult) {
        log.info("[TemplateController.createTemplate] - Creating template");

        ResponseEntity<ApiResponse<Template>> validationResponse = ValidationUtils.handleFormValidation(bindingResult);
    ...
    public ResponseEntity<ApiResponse<Template>> updateTemplate(@Valid @RequestBody TemplateUpdateForm form,
            BindingResult bindingResult) {
    ...
    public ResponseEntity<ApiResponse<Page<Template>>> searchTemplates(@RequestBody TemplateSearchForm form) {
        ...
        Page<Template> page = new Page<>(templates, pageMetadata.getTotalPages(), pageMetadata.getTotalRows());
