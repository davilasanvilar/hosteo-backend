...
class ImportBookingControllerTest extends BaseControllerTest {
  ...
  class ImportBookings {
    ...
    void When_ImportAirbnbBooking_Ok() throws Exception {
      ...
      assertEquals(BOOKING_COUNT_AFTER_IMPORT, importedBookings.size());
      assertEquals(
    ...
    void When_ImportAirbnbBookingSomeConflicts_Ok() throws Exception {
      ...
      testSetupHelper.resetImportConflicts();
      ...
      importedBookings.forEach(
          impBookingDto -> {
            if (impBookingDto.getName().equals(CONFLICTED_BOOKING_NAME)) {
            ...
            } else if (impBookingDto.getName().equals(CONFLICTED_BOOKING_NAME_2)) {
              assertNotNull(impBookingDto.getConflict());
